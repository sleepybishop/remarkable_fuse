...
ok(!-f "$mnt_dir/MyPDF Annotations/page_000001.pdf", "Individual PDF page is NOT accessible when disabled");
...
ok(-f "$mnt_dir/MyPDF Annotations/page_000001.pdf", "Individual PDF page is accessible when enabled");
